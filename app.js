...
function renderProductList() {
    ...
    products.forEach((product, index) => {
        ...
        productDiv.innerHTML = `
            ...
            <button onclick="renderSoldList(${index})" class="btn btn-danger">Vendido</button>
        `;
...
function searchProducts() {
    ...
    filteredProducts.forEach((product, index) => {
        ...
        productDiv.innerHTML = `
            ...
            <button onclick="sellProduct(${index})" class="button">Vender</button>
        `;
        productListDiv.appendChild(productDiv);
    });
}
...
function showEditForm(index) {
    ...
    let editFormHTML = `
        <div id="editForm">
            ...
            <button onclick="updateProduct(${index})" class="button">Actualizar</button>
            <button onclick="cancelEdit()" class="button">Cancelar</button>
        </div>
    `;
